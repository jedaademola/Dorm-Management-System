...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"/>
    ...
    <!-- banner-slider -->
    <link href="${cp}/css/jquery.slidey.min.css" rel="stylesheet">
    <!-- //banner-slider -->
    <!-- pop-up -->
    <link href="${cp}/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
    <!-- //pop-up -->
    <!-- font-awesome icons -->
...
<script src="${cp}/js/jquery.slidey.js"></script>
<script src="${cp}/js/jquery.dotdotdot.min.js"></script>
<script type="text/javascript">
    $("#slidey").slidey({
        interval: 8000,
        listCount: 5,
    ...
    <div class="container">
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#imdb" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb"
...
<div class="Latest-tv-series">
    ...
    <div class="container">
        ...
        <!-- flexSlider -->
        <link rel="stylesheet" href="${cp}/css/flexslider.css" type="text/css" media="screen" property=""/>
        <script defer src="${cp}/js/jquery.flexslider.js"></script>
        <script type="text/javascript">
...
<!-- pop-up-box -->
<script src="${cp}/js/jquery.magnific-popup.js" type="text/javascript"></script>
<!--//pop-up-box -->
