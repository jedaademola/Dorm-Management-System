...
<head>
    ...
    <title>Dorm Management System: Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand" href="{cp}/dashboardAdmin">Dorm Management System</a>
        </div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${cp}/dashboardAdmin"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
