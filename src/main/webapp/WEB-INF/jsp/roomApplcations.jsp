...
<head>
	...
	<title>Dorm Management System: Admin View Applications</title>
						...
						<div class="dataTable_wrapper">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tr >
									...
									<th rowspan=2 style="text-align:center;">Application Date</th>
									<th rowspan=2 style="vertical-align:middle;">Arriving Date</th>
									<th rowspan=2 style="text-align:center;">Student ID</th>
									<th rowspan=2 style="text-align:center;">Building Number</th>
									<th rowspan=2 style="text-align:center;">Room Number</th>
									<th rowspan=2 style="text-align:center;">Status</th>
									<th rowspan=4 style="vertical-align:middle;">Action</th>
								</tr>
								</thead>
								<tbody>
<c:forEach items="${Application}" var="r">
								<tr>
									<td>${r.id}</td>
									<td>${r.applicationDate}</td>
									<td>${r.arrivingDate}</td>
									<td>${r.student.getStudentId()}</td>
									<td>${r.buildingNo.getBuildingNo()}</td>
									<td>${r.roomNo.getRoomNo()}</td>
									<td>${r.status}</td>


									<td><button class="btn btn-danger" onclick="api.rejectApplication(${r.id})">Reject</button>

										<button class="btn btn-success" onclick="api.approveApplicationApplication(${r.id})">Approve</button></td>
								</tr>
</c:forEach>
								</tbody>
							</table>
